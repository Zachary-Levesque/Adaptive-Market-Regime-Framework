    ...
    def build_environment(
        ...
        *,
        ...
        return TradingEnvironment(
            ...
            long_fraction=self.config.risk.long_fraction,
            short_fraction=self.config.risk.short_fraction,
            weighting_method=self.config.risk.weighting_method,
            volatility_lookback=self.config.risk.volatility_lookback,
            volatility_floor=self.config.risk.volatility_floor,
            max_position_weight=self.config.risk.max_position_weight,
            rebalance_interval_days=self.config.risk.rebalance_interval_days,
